...
public class ItemAnimation {
    ...
    // Animation Duration
    public static final long DURATION_IN_BOTTOM_UP = 150;
    public static final long DURATION_IN_FADE_ID = 300;
    public static final long DURATION_IN_LEFT_RIGHT = 150;
    public static final long DURATION_IN_RIGHT_LEFT = 150;
